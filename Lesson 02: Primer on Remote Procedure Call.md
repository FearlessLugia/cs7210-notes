...
![Lesson 2 slide 4: 2. Client-Server Architecture](slides/lesson-02/page-04.png)
...
![Lesson 2 slide 6: 3. Challenges in Client-Server](slides/lesson-02/page-06.png)
...
![Lesson 2 slide 8: 4. Role of RPC](slides/lesson-02/page-08.png)
...
![Lesson 2 slide 9: 4. Role of RPC](slides/lesson-02/page-09.png)
...
![Lesson 2 slide 10: 4. Role of RPC](slides/lesson-02/page-10.png)
...
![Lesson 2 slide 15: 6. Anatomy of an RPC Call](slides/lesson-02/page-15.png)
...
![Lesson 2 slide 18: 6. Anatomy of an RPC Call](slides/lesson-02/page-18.png)
...
![Lesson 2 slide 19: 6. Anatomy of an RPC Call](slides/lesson-02/page-19.png)
...
![Lesson 2 slide 21: 6. Anatomy of an RPC Call](slides/lesson-02/page-21.png)
...
![Lesson 2 slide 24: 7. Invocation Semantics of RPC Operations 1](slides/lesson-02/page-24.png)
...
![Lesson 2 slide 27: 8. Invocation Semantics of RPC Operations 2](slides/lesson-02/page-27.png)
...
![Lesson 2 slide 28: 8. Invocation Semantics of RPC Operations 2](slides/lesson-02/page-28.png)

Clearly, what's more practical to expect is that the RPC system supports at-most-once semantics. The difference between explicitly saying that the call semantics are at-most-once, is that the client or the developer of the client application knows that that is the guarantee the RPC system will provide, and it can program the application such that it behaves correctly even in the case if the call is executed once successfully, or in the case if it's not executed at all.

![Lesson 2 slide 29: 8. Invocation Semantics of RPC Operations 2](slides/lesson-02/page-29.png)

Another option is that the RPC system keeps re-transmitting the request, but if there are no guarantees that it will remove duplicates, then what we'll end up with is at-least-once semantics.
...
![Lesson 2 slide 36: 10. Examples of RPC Systems: gRPC](slides/lesson-02/page-36.png)
